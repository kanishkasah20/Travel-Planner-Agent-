...
from helpers.constants import COUNTRY_ALIASES, COUNTRY_MAIN_AIRPORT, CITY_MAIN_AIRPORT, BASE_URL
...
def parse_route(query: str):
    ...
    IN, NRT    -> filtered route
    IN, None   -> all flights from IN
    ...
    # Direct IATA code route: IN to NRT
